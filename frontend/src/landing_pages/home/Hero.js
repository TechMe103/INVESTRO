    ...
    return ( 
        <div className="container p-5 mb-5">
            <div className='row text-center'>
                ...
                <button className= 'p-2 btn btn-primary' style={{width:"40%" , margin:"0 auto"}} onClick={() => navigate('/')}> Get started </button> 
                <button className= 'p-2 btn btn-primary' style={{width:"40%" , margin:"0 auto"}} onClick={() => navigate('/signup')}>Signup Now</button>
